...
public class T_syn_1_acumen extends Fragment {
    TextView question;
    RadioGroup rg;
    ...
    public static T_syn_1_acumen newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_t_syn_1_acumen, container, false);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                T_syn_1_cloister mfragment=new T_syn_1_cloister();
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                T_syn_1_acme fragment=new T_syn_1_acme();
                Bundle bundle=new Bundle();
