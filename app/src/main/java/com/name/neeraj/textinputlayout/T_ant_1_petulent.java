...
public class T_ant_1_petulent extends Fragment {
    TextView question,count1;
    RadioGroup rg;
    RadioButton option1,option2, option3, option4;
    Button next,previous;
    String text4,choose1,choose2,choose3,choose4,choose5,choose6,choose7,choose8,qn1,qn2,qn3,qn4,qn5,qn6,qn7,qn8;
    int count,temp;

    public static T_ant_1_petulent newInstance() {
        T_ant_1_petulent fragment = new T_ant_1_petulent();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_t_ant_1_petulent, container, false);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                T_ant_1_puerile mfragment=new T_ant_1_puerile();
