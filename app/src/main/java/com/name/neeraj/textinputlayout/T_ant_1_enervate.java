...
public class T_ant_1_enervate extends Fragment {
    TextView question;
    RadioGroup rg;
    RadioButton option1, option2, option3, option4;
    Button next, previous;
    String text4,choose1,choose2,choose3,choose4,choose5,choose6,qn1,qn2,qn3,qn4,qn5,qn6;

    int count,temp;

    public static T_ant_1_enervate newInstance() {
        T_ant_1_enervate fragment = new T_ant_1_enervate();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_t_ant_1_enervate, container, false);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FragmentTransaction transaction=getFragmentManager().beginTransaction();
                T_ant_1_cloister fragment=new T_ant_1_cloister();
