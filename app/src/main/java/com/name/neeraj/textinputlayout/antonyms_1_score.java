...
public class antonyms_1_score extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_antonyms_1_score, container, false);
        ...
        retaketest_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                T_ant_1_acme mfragment=new T_ant_1_acme();
        ...
        viewanswers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentTransaction transection=getFragmentManager().beginTransaction();
                antonyms_1_testanswers mfragment=new antonyms_1_testanswers();
