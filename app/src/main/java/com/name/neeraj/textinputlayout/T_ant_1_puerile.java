...
public class T_ant_1_puerile extends Fragment {
    ...
    public static T_ant_1_puerile newInstance() {
        T_ant_1_puerile fragment = new T_ant_1_puerile();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_t_ant_1_puerile, container, false);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                T_ant_1_warmonger mfragment=new T_ant_1_warmonger();
