...
public class T_syn_1_petulent extends Fragment {
    ...
    public static T_syn_1_petulent newInstance() {
        T_syn_1_petulent fragment = new T_syn_1_petulent();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_t_syn_1_petulent, container, false);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                T_syn_1_mundane mfragment=new T_syn_1_mundane();
                Bundle bundle=new Bundle();
