...
public class antonyms_1_testanswers extends Fragment {
    ...
    public static antonyms_1_testanswers newInstance() {
        antonyms_1_testanswers fragment = new antonyms_1_testanswers();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_antonyms_1_testanswers, container, false);
        ...
        back_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                antonyms_1_score mfragment=new antonyms_1_score();
        ...
        cans3.setText("Exposed");
        cans4.setText("Energize");
        cans5.setText("Gourmet");
        cans6.setText("Drunk");
        cans7.setText("Special");
        cans8.setText("Pleasant");
