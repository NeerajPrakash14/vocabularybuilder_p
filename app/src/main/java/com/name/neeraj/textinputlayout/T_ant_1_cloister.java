...
public class T_ant_1_cloister extends Fragment {
    TextView question;
    RadioGroup rg;
    ...
    int count,temp;
    public static T_ant_1_cloister newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_t_ant_1_cloister, container, false);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                T_ant_1_enervate mfragment=new T_ant_1_enervate();
