...
public class tfenervateFragment extends Fragment {
    TextView question;
    RadioGroup rg;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_tfenervate, container, false);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tferuditionFragment mfragment=new tferuditionFragment();
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FragmentTransaction transaction=getFragmentManager().beginTransaction();
                tfcloisterFragment fragment=new tfcloisterFragment();
