...
public class T_ant_1_warmonger extends Fragment {
    ...
    public static T_ant_1_warmonger newInstance() {
        T_ant_1_warmonger fragment = new T_ant_1_warmonger();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     View v=inflater.inflate(R.layout.fragment_t_ant_1_warmonger, container, false);
