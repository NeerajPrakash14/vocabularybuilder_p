...
public class T_ant_1_glutton extends Fragment {
    TextView question;
    RadioGroup rg;
    ...
    public static T_ant_1_glutton newInstance() {
        T_ant_1_glutton fragment = new T_ant_1_glutton();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_t_ant_1_glutton, container, false);
