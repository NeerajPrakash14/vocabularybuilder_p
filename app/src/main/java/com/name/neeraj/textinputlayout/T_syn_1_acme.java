...
public class T_syn_1_acme extends Fragment {
    TextView question;
    RadioGroup rg;
    ...
    public static T_syn_1_acme newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.fragment_t_syn_1_acme, container, false);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                T_syn_1_acumen mfragment=new T_syn_1_acumen();
