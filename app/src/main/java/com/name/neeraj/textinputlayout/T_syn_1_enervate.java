...
public class T_syn_1_enervate extends Fragment {
    TextView question;
    RadioGroup rg;
    ...
    public static T_syn_1_enervate newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_t_syn_1_enervate, container, false);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                T_syn_1_glutton mfragment=new T_syn_1_glutton();
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FragmentTransaction transaction=getFragmentManager().beginTransaction();
                T_syn_1_cloister fragment=new T_syn_1_cloister();
